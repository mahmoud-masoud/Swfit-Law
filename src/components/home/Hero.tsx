        ...
        <div className='pt-40 flex justify-between gap-6'>
          <div className='lg:w-1/2'>
            ...
            >
              ...
              bg-secondary hover:bg-secondary/80 duration-200 mt-8 inline-block
              '
              >
                Free Consultation
              </Link>
          ...
          <div
           ...
           flex-col bg-black/40 rounded-lg p-6 max-lg:hidden'
          >
            <div className='flex flex-col items-center mb-10'>
              <div
                className='text-7xl text-bright-gold font-bold inline-block mb-4
            '
              >
                +500
              </div>
            ...
            <div className='flex justify-between gap-6'>
              <div className='text-center flex items-center gap-4 '>
                <div className='text-4xl font-medium text-bright-gold mb-2'>
                  20
                </div>
              ...
              <div className='text-center flex items-center gap-4 '>
                ...
                <p className='text-2xl text-white'>Success rate</p>
              </div>
            </div>
          </div>
        </div>
