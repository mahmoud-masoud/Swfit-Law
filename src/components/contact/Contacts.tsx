...
const Contacts = () => {
  return (
    <div className='py-10 md:py-16 px-4 md:px-8 bg-blue-50 rounded-lg'>
      <div className='flex justify-between flex-wrap gap-y-10 gap-4'>
        <div className='flex items-center gap-4'>
          ...
          <div className=''>
            <div className='text-dark mb-2 text-lg'>Call Us On: </div>
        ...
        <div className='flex items-center gap-4'>
          ...
          <div className=''>
            <div className='text-dark mb-2 text-lg'>Email Us: </div>
        ...
        <div className='flex items-center gap-4'>
          ...
          <div className=''>
            <div className='text-dark mb-2 text-lg'>Main Office: </div>
